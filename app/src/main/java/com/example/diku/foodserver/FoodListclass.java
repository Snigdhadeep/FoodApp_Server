...
public class FoodListclass extends AppCompatActivity {
    ...
    EditText et_additemName,et_additemdescription,et_additemPrice,et_additemDiscount;
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            imageFolder.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                   ...
                                   foodList.setName(et_additemName.getText().toString());
                                   foodList.setDiscount(et_additemDiscount.getText().toString());
                                   foodList.setDescription(et_additemdescription.getText().toString());
                                   foodList.setPrice(et_additemPrice.getText().toString());
                                   foodList.setImage(uri.toString());
                                }
                            });
